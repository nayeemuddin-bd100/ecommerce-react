                ...
                <div className="relative">
                    ...
                    <div className="group absolute top-3 right-4 bg-yellow-500 rounded-full  p-2 gap-1 text-xs  transition-all ">
                        ...
                        >
                            ...
                            <HeartIcon
                                className={`w-5 ${
                                    added ? 'fill-current text-black object-fill' : ''
                                }`}
                            />
                        </button>
                    </div>
